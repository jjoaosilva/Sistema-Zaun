            ...
            <div class="row">
                ...
                <!--    <h4 class="col s7">Escolha uma consulta:</h4> <br>-->     
                    <ul id='dropdown2' class="dropdown-content">
                        ...
                        <li><a href="#!"><input type="button" id="a" class="btn col s7 offset " data-toggle="collapse" data-target="#02" value="Questao 02"></a></li>
                        ...
                        <li><a href="consultas15.php"><input type="button" id="a" class="btn col s7 offset " data-toggle="collapse" data-target="#14" value="Questao 15"></a></li>
